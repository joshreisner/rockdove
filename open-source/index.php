...
<p>Site requirements are PHP and MySQL. Here is a <a href="schema.sql">blank database schema</a> you can use, current as of <?php echo format_date(filemtime("schema.sql"))?>.</p>
